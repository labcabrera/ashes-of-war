...
- *To-Hit:* determina la facilidad o dificultad de un blanco para ser impactado por un disparo. Objetivos grandes y estáticos como un _KV-2_ tendrán valores bajos, mientras que objetivos pequeños, móviles tales como la infantería tendrán valores más altos.

- *Balistic:* bonificación base del arma para lograr un impacto. Este valor combinará tanto la capacidad de apuntado del arma como la habilidad del tirador. En el caso de armas con diferentes perfiles de disparo este valor podrá ser diferente. Por ejemplo, una ametralladora pesada podrá realizar ráfagas cortas y precisas con un valor de _balistic_ que siendo utilizada para dar fuego de apoyo donde tendrá mayor cadencia de disparo a costa de un menor valor de _balistic_.
