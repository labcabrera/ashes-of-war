...
La linea de visión se trazará desde el punto de disparo hasta el objetivo. En los casos de disparos de armas instaladas en la torreta será necesario que el cañon tenga línea de visión al objetivo, mientras que en el caso de armas instaladas en la barcaza o en el casco del vehículo se trazará la línea de visión desde el punto de disparo hasta el objetivo. En el caso de disparos realizados por infantería se trazará la línea de visión desde la miniatura del soldado que dispara hasta el objetivo.
...
----
{Rango}/{Incremento}/{Penalizador}
----

Siendo:

- *[.underline]#Rango#:* distancia en la que el arma no sufre penalización por distancia.

- *[.underline]#Incremento#:* rango de distancia que utilizado para calcular la penalización por distancia. Por ejemplo, si el valor es 6 pulgadas, cada 6 pulgadas adicionales a la distancia inicial se aplicará una penalización.

- *[.underline]#Penalizador#:* penalización por cada incremento de distancia. Este valor se aplicará a la tirada de impacto por cada incremento de distancia que supere la distancia inicial.
...
WARNING: sección sin actualizar copiada de las notas iniciales.

=== Modificadores de disparo

|===
|Modificador                         |Valor |Descripción
|Nivel de organización               |-X    |6 menos el nivel de organización de la unidad que dispara.
|Cobertura ligera                    |-2    |Cobertura parcial o ligera.
|Cobertura pesada                    |-4    |Cobertura parcial o ligera.
|Bunker / emplazamiento atrincherado |-6    |Cobertura parcial o ligera.
|Disparando en movimiento            |-X    |Dependiente del perfil del arma. Por ejemplo "Heavy 2" indicará un -2 al disparo si la unidad no permanece estacionaria.
|Humo / Polvo ligero                 |-2    |Condiciones de humo, polvo o niebla que dificultan la visibilidad.
|Humo / Polvo intenso                |-4    |Condiciones de humo, polvo o niebla que dificultan la visibilidad.
|Aputado preciso                     |+X    |Algunos perfiles de arma pueden sacrificar cadencia de fuego para mejorar la puntería. Por ejemplo "Aimed +2" indicará que el arma obtiene un bonus de +2 al disparo si realiza un disparo apuntado.
|
|===
...
[NOTE]
====
*Ejemplo de un disparo de vehículo*

Un Panzer IV estático dispara a un KV-1 a 32' en condiciones con humo ligero sin cobertura saca un 4

* Tirada: 4
* HP Panzer IV (Balistic +3)
* Distancia (30/10/-1): -1
* Humo: -1
* KV-1: Hit-On 3
* Resultado total: 5 (4+3-1-1), como el resultado es igual o superior al hit-on del objetivo el disparo impacta con éxito.

*Ejemplo de un disparo de una MG-34 contra una unidad de infantería*
...
Dependiendo del tipo de arma disparada y el objetivo los impactos se resolverán de forma diferente.


WARNING: notas antiguas pendientes de mover a las secciones correspondientes y eliminar.

El resultado de los impactos dependenderá del tipo de disparo.
