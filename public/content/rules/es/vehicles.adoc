...
*Blindaje efectivo = Escala x (Blindaje en mm / cos(θ))*
...
WARNING: TODO: indicar que los vehiculos no se retiran de la mesa cuando son destruidos... salvo que sean destruidos por armas de escala atómica o cañones ferroviarios.